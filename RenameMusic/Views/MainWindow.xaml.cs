...
namespace RenameMusic.Views
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            #region Themes
            foreach (string themeName in ThemeService.Themes)
            {
        ...
        {
            bool canRename = DataAccessLayer.CountAudioItems(true) > 0;
        ...
        private void LoadData()
        {
            ...
            //            DataAccessLayer.GetPageOfAudios(Settings.Default.PageSize, CurrentPage, true)
            //            );

            //        ContentLoadedSBar.Text = string.Format(format,
            //            PrimaryList.Items.Count, DataAccessLayer.CountAudioItems(true));
            //        break;
            //    case 1:
            //        SecondaryList.Items.AddRange(
            //            DataAccessLayer.GetPageOfAudios(Settings.Default.PageSize, CurrentPage, false)
            //            );

            //        ContentLoadedSBar.Text = string.Format(format,
            //            SecondaryList.Items.Count, DataAccessLayer.CountAudioItems(false));
            //        break;
            //    case 2:
            //        FolderList.Items.AddRange(
            //            DataAccessLayer.GetPageOfFolders(Settings.Default.PageSize, CurrentPage)
            //            );

            //        ContentLoadedSBar.Text = string.Format(format,
            //            FolderList.Items.Count, DataAccessLayer.CountFolderItems());
            //        break;
            //}
        }
        #endregion Util
        ...
        private async void AddFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            await Task.Run(() =>
            {
                DataAccessLayer.BeforeAddToDB(files);
        ...
        {
            int totalItems = DataAccessLayer.CountAudioItems(true);
            ...
            await Task.Run(() =>
            {
                while (CurrentPage <= totalItems)
                {
                    ...
                    List<Audio> PartialAudioList = DataAccessLayer.GetPageOfAudios(Settings.Default.PageSize, CurrentPage, true);
        ...
        private void RemoveFolderItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataAccessLayer.RemoveFolderFromDB(folderId);
        ...
        private void RenameThisNow_Click(object sender, RoutedEventArgs e)
        {
            ...
            FilenameFunctions.RenameFile(oldName, newName);
            DataAccessLayer.RemoveAudioFromDB(audio.Id);
            PrimaryList.Items.Clear();
            SecondaryList.Items.Clear();
            FolderList.Items.Clear();
            LoadData();
